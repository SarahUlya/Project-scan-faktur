  ...
  return (
    <div style={{ minWidth: 340, maxWidth: 420 }}>
      <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 12 }}>
        ...
        <h2 style={{ fontWeight: 800, fontSize: 20, margin: 0 }}>Konfirmasi Hapus Supplier</h2>
        ...
        <div style={{ background: "#F3F6F9", borderRadius: 12, padding: 12, width: "100%", display: "flex", alignItems: "center", gap: 10, margin: "12px 0" }}>
          ...
          <div>
            <div style={{ fontWeight: 700, fontSize: 15 }}>{supplier?.nama}</div>
            <div style={{ color: "#B0B0B0", fontSize: 13 }}>ID: {supplier?.id}</div>
          </div>
        </div>
