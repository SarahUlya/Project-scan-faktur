      ...
      <Box sx={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 1.5 }}>
        ...
        <Box sx={{
          ...
          <Box sx={{ textAlign: 'left' }}>
            <Typography sx={{ fontWeight: 800, color: '#1E293B', fontSize: 15 }}>{produk?.nama}</Typography>
            <Typography sx={{ color: "#94A3B8", fontSize: 13, fontWeight: 600 }}>ID: {produk?.id}</Typography>
          </Box>
        </Box>
